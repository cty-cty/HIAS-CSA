...
function InputGroupAddon({
  ...
  return (
    <div
      ...
      // This is an adornment, not another button in the tab order. Keyboard
      // users focus the native input directly; pointer/touch users can also
      // focus it through the adornment without changing nested button actions.
      onPointerDown={(e) => {
